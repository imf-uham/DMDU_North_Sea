...
"""     
f_old = pd.read_csv('/home/jan/PhD/Data/Lindegren_Papers/Cod_North_Sea/FatAge.txt', sep = '	') # natural mortality per age-class and year
...
m_old = pd.read_csv('/home/jan/PhD/Data/Lindegren_Papers/Cod_North_Sea/MatAge.txt', sep = '	') # natural mortality per age-class and year
...
wt_old = pd.read_csv('/home/jan/PhD/Data/Lindegren_Papers/Cod_North_Sea/WatAge.txt', sep = '	') # weight in the stock per age-class and year
...
wt_ct_old = pd.read_csv('/home/jan/PhD/Data/Lindegren_Papers/Cod_North_Sea/WatAge_Catch.txt', sep = '	') # weight in the catch  
...
mt_old = pd.read_csv('/home/jan/PhD/Data/Lindegren_Papers/Cod_North_Sea/PatAge.txt', sep = '	') # maturity rates per age-class and year
...
numbers = pd.read_csv('/home/jan/PhD/Data/Lindegren_Papers/Cod_North_Sea/NatAge.txt', sep = '	') # numbers of fish in the stock per age-class 
# and year
...
"""
catch_old_full = pd.read_csv('/home/jan/PhD/Data/Lindegren_Papers/Cod_North_Sea/Catch_AY.txt', sep = '	') # catch in numbers per age-class 
# and year
catch_old_full = np.transpose(np.array(catch_old_full))
catch_old_full = catch_old_full[1:,:]
    
catch_tot = pd.read_csv('/home/jan/PhD/Data/Lindegren_Papers/Cod_North_Sea/Catch.txt', sep = '	') # total catches (in weight)
...
time_series.to_csv('/home/jan/PhD/EMA/Catch_Ricker.csv') # saving the stock metrics to disk

params = pd.DataFrame(params)

params.to_csv('/home/jan/PhD/EMA/Catch_Ricker_Params.csv') # saving the uncertain parameters and policies to disk
