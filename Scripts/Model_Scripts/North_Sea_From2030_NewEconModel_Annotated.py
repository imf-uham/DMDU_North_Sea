...
def make_past_profit(): # function for calculating past profit
    ...
    cost = co * catch_tot # calculating past cost
...
past_profit = np.min(profit_past) # determining the minimum historical profit (used as custom economic reference point for calculation of profitability risk)
